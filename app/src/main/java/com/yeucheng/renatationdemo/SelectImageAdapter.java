...
public class SelectImageAdapter extends RecyclerCommonAdapter<String> {
    ...
    public SelectImageAdapter(Context context,  int maxCount, int layoutId) {
    ...
    //加载数据
    public void loadData(List<String> data,List<String> choice){
        super.loadData(data);
        this.imageList = choice;
        notifyDataSetChanged();
    }
    public SelectImageAdapter(Context context,  MulitiType typeSupport) {
